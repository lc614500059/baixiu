...
<body>
    <div>
        ...
        <dl>
           <dt><a href="#"><?php echo $value[ "title" ] ?></a></dt>
           <dd>
               <p><?php echo $value[ "datetime" ] ?></p>
               <p><h3><?php echo $value[ "desc" ] ?><a href="#"><?php echo $value[ "lianjie" ] ?></a><?php echo $value[ "mei" ] ?></h3></p>
               <p><a href="#"><?php echo $value[ "other" ] ?></a></p>
               <p><a href="#"><?php echo $value[ "kuaizhao" ] ?></a><span><?php echo $value[ "baidu" ] ?></span></p>
